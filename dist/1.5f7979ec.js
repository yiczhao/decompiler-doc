...
/***/ function(module, exports) {
	...
	exports.default = [{
	    name: '开发指南 Guide',
	    subMenu: [{ name: '简介', icon: 'icon', link: 'install' }]
	}, {
	    name: '基础布局',
	    ...
	    name: '验证 Validate',
	    subMenu: [{ name: '简介', icon: 'icon', link: 'briefIntroduction' }, { name: '了解规则', icon: 'icon', link: 'understandingRules' }, { name: 'DOM 绑定', icon: 'icon', link: 'domBindings' }, { name: '方法 & 事件', icon: 'icon', link: 'methodAndEvent' }, { name: 'demo 示例', icon: 'icon', link: 'validatorDemo' }, { name: 'remote 远程验证', icon: 'icon', link: 'remote' }]
	}, {
	    name: '日志 Log',
